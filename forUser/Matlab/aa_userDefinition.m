...
generalDirectory = 'G:\Drive condivisi\DesignMechatronicSystem\SmartTrainer\forUser';
currDate = strrep(datestr(datetime), ':', '_');

% where will you locate the file?
dataDirectory=[generalDirectory, '\Data\', num2str(frequency),'Hz\'];

if personalCalibration == true
    mkdir(dataDirectory,currDate);
    filesDirectory=[generalDirectory, '\Data\', num2str(frequency),'Hz\',currDate,'\' ];
end
...
numberOfRep = floor(secDuration/secToMove);
