...
[labels_sent_array time_sent_array] = postProc_findLabelDemoNoLoop(labels_array, timeArray, secondsThresholdActivation, sendingTime, secondsBeforeLabel, features(:,10));
